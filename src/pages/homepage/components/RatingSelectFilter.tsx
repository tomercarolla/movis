...
export function RatingSelectFilter({setRatingFilter}: RatingSelectFilterProps) {
    return <Select onChange={setRatingFilter} options={ratingOptions} placeholder='Filter by rating' />
}